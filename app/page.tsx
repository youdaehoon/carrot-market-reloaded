    ...
    >
      ...
      >
        ...
        <div className="my-2 flex items-center gap-2">
          <span
            className="bg-green-400 text-white uppercase px-2.5 py-1.5 text-xs font-medium rounded-full transition
           hover:bg-green-500  hover:scale-125
           "
          >
            Today
          </span>
          <span className="dark:text-gray-100">9:103~10:30</span>
        </div>
        ...
        <div
          className="flex justify-between items-center mt-5 text-gray-600 font-medium
        dark:text-gray-300
        "
        >
          <span>Expected</span>
